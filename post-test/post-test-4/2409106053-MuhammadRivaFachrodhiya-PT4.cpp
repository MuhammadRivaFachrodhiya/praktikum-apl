...
void tambahFurniture() {
    if (jumlahFurniture >= MAX_FURNITURE) {
        cout << "Kapasitas penuh!\n";
        return;
    }
    cin.ignore();
    cout << "Nama\t\t: "; getline(cin, furnitures[jumlahFurniture].nama);
...
void editFurniture() {
    ...
    if (index >= 0 && index < jumlahFurniture) {
        cin.ignore();
        cout << "Nama: "; getline(cin, furnitures[index].nama);
...
void hapusFurniture() {
    ...
    if (index >= 0 && index < jumlahFurniture) {
        for (int i = index; i < jumlahFurniture - 1; i++) {
...
void registrasi() {
    ...
    if (jumlahUsers >= MAX_USERS) {
        ...
        cin.ignore();
        cout << "Username: "; getline(cin, users[jumlahUsers].username);
        cout << "Password: "; getline(cin, users[jumlahUsers].password);
